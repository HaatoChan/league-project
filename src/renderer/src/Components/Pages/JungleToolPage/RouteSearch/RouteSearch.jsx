...
const RouteSearch = () => {
	...
	const {newImport, setNewImport} = useContext(SideBarContext)
	...
	return ( 
		<div className="routesearch">
			<p className="nameOfCurrentlySelected" data-testid={'currentlySelected' + newImport?.name} style={{ color: 'white'}}>{newImport?.name}</p>
